...
defined("PAYCOM_ID") or define("PAYCOM_ID", "*");                              /// osnovnoy
defined("PAYCOM_KEY") or define("PAYCOM_KEY", "*");                /// osnovnoy
...
class ClickPayme extends CApplicationComponent
{
    ...
    public function ClickCardPayment($token, $amount)
    {
        ...
        return json_decode($this->curlPost("https://api.click.uz/v2/merchant/card_token/payment", json_encode($body), $headers));
    }
    ...
    public function ClickCardVerify($token, $code)
    {
        ...
        return json_decode($this->curlPost("https://api.click.uz/v2/merchant/card_token/verify", json_encode($body), $headers));
    }
    ...
    public function ClickCardCreate($number, $expire, $temp = 0)
    {
        ...
        return json_decode($this->curlPost("https://api.click.uz/v2/merchant/card_token/request", json_encode($body), $headers));
    }
    ...
    {
        $paycom_url = "https://checkout.paycom.uz/api";      // prodakshen
//        $paycom_url = "https://checkout.test.paycom.uz/api";   ////test
